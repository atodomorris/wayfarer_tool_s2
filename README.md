...
6. El menú compacto abre primero una tarjeta de conteos: los números grandes corresponden a **Poképaradas**, **gimnasios** y **nodos** en la S14 tocada. Cada número queda en un recuadro transparente con borde del color configurado y un icono vectorial local de su tipo. Debajo aparece la evaluación de 22 m y la S17. El conteo se limita a la respuesta de mapa disponible; no afirma la elegibilidad de una nominación.
