...
6. El menú compacto abre primero una tarjeta de conteos: los números grandes corresponden a **Poképaradas**, **gimnasios** y **nodos** en la S14 tocada, y usan sus colores configurados. Debajo aparece la evaluación de 22 m y la S17. El conteo se limita a la respuesta de mapa disponible; no afirma la elegibilidad de una nominación.
