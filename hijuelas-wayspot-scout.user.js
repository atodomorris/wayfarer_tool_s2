...
(() => {
  ...
  function updatePanel() {
    ...
    const s17Summary = assessment.s17References.length ? wayspotCountText(assessment.s17References.length) : "Sin Wayspots";
    ...
    <section class="hws-detail-card" aria-label="Wayspots de la celda L17 seleccionada">
      <strong class="hws-card-title">Celda L17 \xB7 ${s17Summary}</strong>
  ...
  function paletteMarkup(layer) {
    ...
    return `${primaryMarkup}<details class="hws-palette-more"${currentInExtra ? " open" : ""}><summary>M\xE1s colores</summary><div class="hws-palette">${extra.map(swatch).join("")}</div></details>`;
  }
  function createUi() {
