...
(() => {
  ...
  function createUi() {
    ...
    #hws-toggle{width:64px;height:64px;border:0;background:#151515;border-radius:20px;display:grid;place-items:center;padding:0;box-shadow:0 12px 28px #000b,0 0 0 3px #151515;overflow:hidden}
    #hws-toggle img{width:50px;height:50px;display:block;object-fit:cover}.hws-title{font-size:18px;letter-spacing:-.035em;color:#f5e9e5}
